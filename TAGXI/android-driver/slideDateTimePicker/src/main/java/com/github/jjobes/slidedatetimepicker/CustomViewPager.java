...
public class CustomViewPager extends ViewPager
{
    ...
    /**
     * When the users swipes their finger horizontally, dispatch
    ...
    public boolean dispatchTouchEvent(MotionEvent event)
    {
        switch (event.getAction())
        {
           ...
           case MotionEvent.ACTION_MOVE:
               ...
               {
                   // When the users is scrolling the ViewPager horizontally,
    ...
    /**
     * Determine whether the distance between the users's ACTION_DOWN
