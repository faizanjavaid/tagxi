...
public class AppChatAdapter extends RecyclerView.Adapter<AppChatAdapter.AppChatHolder> {
    ...
    public AppChatHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == MSG_TYPE_RIGHT) {
           ...
           // mViewDataBinding = DataBindingUtil.inflate(LayoutInflater.from(mContext), R.layout.chat_item_right, parent, false);
            return new AppChatHolder(view);
        } else {
            View view = LayoutInflater.from(mContext).inflate(R.layout.chat_item_left, parent, false);
            //mViewDataBinding = DataBindingUtil.inflate(LayoutInflater.from(mContext), R.layout.chat_item_left, parent, false);
            return new AppChatHolder(view);  }
