...
/**
 * Adapter File to store emergency contact details.
* */
...
public class SosAdapter extends RecyclerView.Adapter<SosAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final SosAdapter.ViewHolder viewHolder, final int i) {
        ...
        viewHolder.delete.setOnClickListener(v -> sosNavigator.onClickDelete(sosModels.get(i)));

        viewHolder.itemView.setOnClickListener(v -> sosNavigator.onClickCall(sosModels.get(i)));
    }
