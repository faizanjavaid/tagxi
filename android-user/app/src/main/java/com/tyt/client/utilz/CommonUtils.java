...
public final class CommonUtils {
   ...
   /* public static String getTimeStamp() {
    ...
    public static boolean isGpscheck(Context context) {
        ...
        return manager.isProviderEnabled(LocationManager.GPS_PROVIDER) && providers.contains(LocationManager.GPS_PROVIDER);
    }

    /**
     * Dialog which is used to show when Gps is disabled.
    * */
    ...
    /**
     * Google's default dialog to enable location permission.
    * */
    ...
    /**
     * It is Used to get the URI of the image from the bitmap.
    * */
