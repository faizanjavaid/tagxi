...
/**
 * <p>This class contains methods for the library Users to create
...
public class SlideDateTimePicker
{
    ...
    /**
     * <p>Sets the listener that is used to inform the Users when
     * the users selects a new date and time.</p>
     *
    ...
    /**
     * Shows the dialog to the users. Make sure to call
     *  before calling this.
     */
    public void show()
    {
