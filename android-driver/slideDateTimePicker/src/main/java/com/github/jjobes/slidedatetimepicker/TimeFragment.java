...
{
    /**
     * Used to communicate back to the parent fragment as the users
    ...
    /**
     * Create and return the users interface view for this fragment.
     */
    @Override
            ...
            Bundle savedInstanceState)
    {
        ...
        // If the Users specifies a 24-hour time format, set it on
        // the TimePicker.
        ...
        {
            // If the Users does not specify a 24-hour time format, use the
            // device default.
        ...
        // the users toggles the AM/PM button. Only applies to 4.0.0 and 4.0.3.
     ...
     * is not invoked when the users toggles between AM/PM. But we need to be able
     * to detect this in order to dynamically update the tab title properly when
     * the users toggles between AM/PM.
     *
