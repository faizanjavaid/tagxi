...
public class HistoryCard {
    ...
    public HistoryCard(String id, String requestNumber, String pickAddress, String dropAddress, Integer isLater, String tripStartTime, Integer isCancelled, String updated_at, Integer isCompleted, RequestBill requestBill,Object arrivedAt, String completedAt) {
        this.id = id;
