...
package com.tyt.driver.utilz.sync.provider;
...
public class FeedContract {
    private static final String TAG = "FeedContract";
     ...
     */
    public static final String CONTENT_AUTHORITY = "com.captaincare.Drivers.Sync";

    /**
     * Base URI. (content://com.captaincare.Drivers.Sync)
     */
